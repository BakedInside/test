#!/usr/bin/env python3
# Copyright (c) 2013-2020 The Beans Core developers
...
def main():
    ...
    # Filter out hosts with multiple beans ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple beans ports' % (ip_stats(ips)), file=sys.stderr)
