...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the beans repository."
  exit 1
fi
...
# See https://github.com/beans/beans/issues/16064
...
echo 'When compiling beansd, run `./configure` in the following way:'
echo
