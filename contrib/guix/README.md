# Bootstrappable Beans Core Builds

This directory contains the files necessary to perform bootstrappable Beans
Core builds.
...
- 24GB of free disk space on the partition that the Beans Core git repository
  resides in
...
For a Beans Core depends development environment, simply invoke
...
From the top of a clean Beans Core repository:
...
To use dongcarl's substitute server for Beans Core builds after having
