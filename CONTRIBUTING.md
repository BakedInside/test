...
First, in terms of structure, there is no particular concept of "Beans Core
...
For GUI-related issues or pull requests, the https://github.com/beans-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/beans/beans node repository should be used.
