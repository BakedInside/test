 ...
 */
#ifndef BEANS_UTIL_SYSTEM_H
#define BEANS_UTIL_SYSTEM_H
...
extern const char * const BEANS_CONF_FILENAME;
extern const char * const BEANS_SETTINGS_FILENAME;
