...
#ifndef BEANS_CRYPTO_CHACHA_POLY_AEAD_H
#define BEANS_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@beans.
 *
 ...
 *
 * The chacha20-poly1305@beans combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@beans cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@beans are relatively fast in
...
#endif // BEANS_CRYPTO_CHACHA_POLY_AEAD_H
