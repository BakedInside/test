...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
  ...
  //  if(Params().NetworkIDString() == CBaseChainParams::MAIN) {
   //     if(nHeight < 26754) {
   //         return GetNextWorkRequired_Beans(pindexLast, pblock, params);
...
unsigned int GetNextWorkRequired_Beans(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
