...
{
    BOOST_CHECK(TestSplitHost("www.beanscore.org", "www.beanscore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.beanscore.org]", "www.beanscore.org", -1));
    BOOST_CHECK(TestSplitHost("www.beanscore.org:80", "www.beanscore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.beanscore.org]:80", "www.beanscore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:5889", "127.0.0.1", 5889));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:5889", "127.0.0.1", 5889));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5889", "::ffff:127.0.0.1", 5889));
    BOOST_CHECK(TestSplitHost("[::]:5889", "::", 5889));
    BOOST_CHECK(TestSplitHost("::5889", "::5889", -1));
    BOOST_CHECK(TestSplitHost(":5889", "", 5889));
    BOOST_CHECK(TestSplitHost("[]:5889", "", 5889));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5889", "127.0.0.1:5889"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:5889", "[::]:5889"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
