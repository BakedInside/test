...
#ifndef BEANS_SCRIPT_STANDARD_H
#define BEANS_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a beans address
 */
...
/**
 * Generate a Beans scriptPubKey for the given CTxDestination. Returns a P2PKH
