...
#ifndef BEANS_VALIDATION_H
#define BEANS_VALIDATION_H
...
static const int64_t DEFAULT_MAX_TIP_AGE = 60 *60 *24 * 365;// sean was 24 * 60 * 60;
static const bool DEFAULT_CHECKPOINTS_ENABLED = false; //sean change back to true
...
bool ReadBlockFromDisk(CBlock& block, const FlatFilePos& pos, const int height, const Consensus::Params& consensusParams);
