...
#ifndef BEANS_WALLET_WALLETUTIL_H
#define BEANS_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! beans from opening the wallet, thinking it was newly created, and
...
#endif // BEANS_WALLET_WALLETUTIL_H
