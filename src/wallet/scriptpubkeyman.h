...
#ifndef BEANS_WALLET_SCRIPTPUBKEYMAN_H
#define BEANS_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Beans Core wallet was originally a collection of unrelated private
...
#endif // BEANS_WALLET_SCRIPTPUBKEYMAN_H
