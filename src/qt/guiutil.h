...
#ifndef BEANS_QT_GUIUTIL_H
#define BEANS_QT_GUIUTIL_H
...
/** Utility functions used by the Beans Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "beans:" URI into recipient object, return true on successful parsing
