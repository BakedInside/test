...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Beans
else
  DOCKER_EXEC echo \> \$HOME/.beans
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/beans/beans/pull/18288#discussion_r433189350 for
  # details.
