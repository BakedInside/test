...
"""Verify that starting beans with -h works as expected."""

from test_framework.test_framework import BeansTestFramework
from test_framework.util import assert_equal

class HelpTest(BeansTestFramework):
    ...
    def run_test(self):
        self.log.info("Start beans with -h for help text")
        ...
        self.log.info("Start beans with -version for version information")
        ...
        self.log.info("Start beansd with -fakearg to make sure it does not start")
