...
# The block reward of coinbaseoutput.nValue (50) BNS/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BNS/block.
BLOCKS = 101
...
class TestBeansCli(BeansTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `beans-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and beans-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 BNS) to the default wallet.
            ...
            # Test beans-cli -generate with -rpcwallet in multiwallet mode.
