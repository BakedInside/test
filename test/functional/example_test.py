...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BeansTestFramework
    pass


class ExampleTest(BeansTestFramework):
    # Each functional test is a subclass of the BeansTestFramework class.
    ...
    def custom_method(self):
        ...
        BeansTestFramework class so other tests can use it."""
