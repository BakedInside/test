...
class P2PPermissionsTests(BeansTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].beansconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].beansconf, 'w', encoding="utf8") as f:
            f.write(newText)
