...
By default, beansd will dump mempool on shutdown and
...
class MempoolPersistTest(BeansTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent beansd from writing mempool.dat to disk. Verify that `savemempool` fails")
